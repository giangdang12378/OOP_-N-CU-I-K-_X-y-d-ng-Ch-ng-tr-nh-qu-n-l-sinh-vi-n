...
namespace projekt
{
    public static class Init
    {
        ...
        public static string rootPath = new DirectoryInfo(Directory.GetCurrentDirectory()).Parent.Parent.Parent.FullName;
        public static string studentdb = Path.Combine(rootPath, "database", "Student.json");
        public static string lecturerdb = Path.Combine(rootPath, "database", "Lecturer.json");
        public static string departmentdb = Path.Combine(rootPath, "database", "Department.json");
        public static string coursedb = Path.Combine(rootPath, "database", "Course.json");
        public static string classdb = Path.Combine(rootPath, "database", "Class.json");
